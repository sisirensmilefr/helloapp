...
@javax.jdo.annotations.PersistenceCapable(identityType = IdentityType.DATASTORE , schema = "cetelem_proto", table= "vehicle" )
@javax.jdo.annotations.DatastoreIdentity(strategy = IdGeneratorStrategy.IDENTITY, column = "vehicle_id")
...
public class VehicleObject implements Comparable<VehicleObject> {
